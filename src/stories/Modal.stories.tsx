          ...
          <Modal.Body>
            <div className="space-y-4">
              {Array.from({ length: 50 }, (_, i) => (
                <p key={i}>
                  This is paragraph number {i + 1}. This modal demonstrates
                  scrollable content when the content exceeds the maximum height
                  of 90vh. The modal body should become scrollable while keeping
                  the header and footer visible.
                </p>
              ))}
            </div>
          </Modal.Body>
